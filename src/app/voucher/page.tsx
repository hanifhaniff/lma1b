...
// Define profile options for voucher creation
              ...
              <CardContent className="p-6">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-2xl font-bold mt-1">{totalVouchers}</p>
                  </div>
              ...
              <CardContent className="p-6">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-2xl font-bold mt-1">{activeVouchers}</p>
                  </div>
              ...
              <CardContent className="p-6">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-2xl font-bold mt-1">{usedVouchers}</p>
                  </div>
          ...
          <Card>
            <CardHeader className="pb-4">
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                <div>
                  <CardTitle className="text-lg sm:text-xl mb-1 flex items-center gap-2">
                    <BarChart className="h-5 w-5 text-blue-500" />
                    Voucher List
                    <Badge variant="secondary" className="ml-2">{vouchers.length}</Badge>
                  </CardTitle>
                </div>
